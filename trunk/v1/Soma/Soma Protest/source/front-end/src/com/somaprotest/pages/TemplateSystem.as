package com.somaprotest.pages {
	...
	public class TemplateSystem extends CanvasPage implements IRemovable {
		...
		public function TemplateSystem() {
		...
		override protected function init():void {
			...
			var imageNode:XML = content.*.(@id == "templateShowing")[0];
		...
		private function imageComplete(e:QueueLoaderEvent):void {
			var templateShowing:Bitmap = e.file as Bitmap;
			templateShowing.y = posY;
			posY = templateShowing.y + templateShowing.height + 7;
			canvas.refresh();
		}
