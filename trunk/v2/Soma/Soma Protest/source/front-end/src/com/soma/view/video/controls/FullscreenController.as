package com.soma.view.video.controls {
     ...
     * 
     * <p><b>Usage:</b><br/>
     * FullscreenController is part of the default video skin system of the SomaVideoPlayer. It is a controller class that is sending data to its skin class (ISomaVideoFullscreenSkin).<br/><br/>
	...
	public class FullscreenController implements ISomaVideoDisposable {

		//------------------------------------
		// private, protected properties
		//------------------------------------
		
		private var _skin:ISomaVideoFullscreenSkin;
		 ...
		 * @param skin A skin instance that is implementing ISomaVideoFullscreenSkin.
		 */
		public function FullscreenController(videoPlayer:SomaVideoPlayer, skin:ISomaVideoFullscreenSkin) {
			_skin = skin;
		...
		protected function init():void {
			if (_videoPlayer != null) {
				_videoPlayer.addEventListener(SomaVideoEvent.FULLSCREEN_CHANGED, eventHandler, false, 0, true);
			}
		}
		
		/** @private */
		protected function eventHandler(e:SomaVideoEvent):void {
			_skin.fullscreenCallBack(_videoPlayer.fullscreen);
		}
		...
		public function dispose():void {
			if (_videoPlayer != null) {
				_videoPlayer.removeEventListener(SomaVideoEvent.FULLSCREEN_CHANGED, eventHandler, false);
			}
		}
