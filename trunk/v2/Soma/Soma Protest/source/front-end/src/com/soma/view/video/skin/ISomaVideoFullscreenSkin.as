package com.soma.view.video.skin {
     ...
     * 
     * <p><b>Usage:</b><br/>
     * Interface meant to implemented by a DisplayObject class (such as Sprite) to skin a fullscreen button skin and be added to the SomaVideoControls (somaVideoPlayerInstance.controls).
     * 
     * See the <a href="SomaVideoFullscreenSkin.html">SomaVideoFullscreenSkin</a> documentation to create your own fullscreen skin and the <a href="controls/SomaVideoControls.html">SomaVideoControls</a> documentation to add or create your own controls.
     * 
	...
	public interface ISomaVideoFullscreenSkin extends ISomaVideoSkin {
		 ...
		 */
		function fullscreenCallBack(value:Boolean):void;
