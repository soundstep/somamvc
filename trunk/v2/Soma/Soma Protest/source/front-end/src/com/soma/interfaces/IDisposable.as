package com.soma.interfaces {
     ...
     * 
     * <p><b>Usage:</b><br/>
     * Force a class to implement a dispose method which is usually used to remove and destroy instances and/or event listeners.
     * A example of a class that is implementing IDisposable is the NodeParser class. You can test your IDisposable classes this way: if (myClassInstance is IDisposable) myInstance.dispose().
     * </p>
     * 
     */
