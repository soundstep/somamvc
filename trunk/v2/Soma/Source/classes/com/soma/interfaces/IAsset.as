package com.soma.interfaces {
     ...
     * 
     * <p><b>Usage:</b><br/>
     * Interface required by the NodeParser to instantiate a custom asset (see example in the Library documentation, link below).
     * </p>
     * 
	...
	public interface IAsset {
		/** Instantiates an asset and return a DisplayObject.
		 * @param node XML node describing the asset and containing the properties or this asset.
		 * @param baseUI BaseUI instance used to handle any BaseUI properties (such as top, bottom and so on) found in the XML node.
		 */
		function instantiate(node:XML, baseUI:BaseUI = null):DisplayObject;
	}
}
