package com.soma.interfaces {
     ...
     * 
     * <p><b>Usage:</b><br/>
     * Force a class to have a complete method, used to make an action after another that is taking time (tweening, loading, etc).<br/><br/>
     * An example can be found in the <a href="http://www.soundstep.com/somaprotest/www/#/basics/commands/sequence/" target="_blank">Soma Protest Sequence Command</a>.
     * </p>
     * 
     */
	...
	public interface IComplete {
		 ...
		 * @param data Object that can contain anything.
		 */
